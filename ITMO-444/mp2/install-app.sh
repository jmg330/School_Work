...
git clone git@github.com:illinoistech-itm/jgriffith.git /home/ubuntu/jgriffith
...
sudo chown -R ubuntu:ubuntu /home/ubuntu/jgriffith
...
cd /home/ubuntu/jgriffith/ITMO-444/mp2/
